...
const SIGN_IN_PATH = '/auth/sign-in?redirect=/admin/lectures';

/**
 * Fail-closed admin gate, matching /admin/recordings:
...
export default async function AdminLecturesPage() {
  ...
  try {
    ...
    console.error('[admin-lectures-page] auth check failed', error);
    notFound();
  }
