 ...
 * page paints: `/try/talk` created that row, so the case is a database fact
 * rather than a `?stationId=` a visitor could edit, and the call screen can ask
 * for the microphone on arrival instead of after two client fetches.
 */
      ...
      <div className="min-h-[100dvh] bg-surface flex items-center justify-center px-6">
        <div className="max-w-sm text-center">
          ...
          <p className="mb-6 text-[14px] leading-relaxed text-muted">
            It may have finished, or been left too long. Starting another takes one click.
          </p>
          <Link
            href="/try/talk"
