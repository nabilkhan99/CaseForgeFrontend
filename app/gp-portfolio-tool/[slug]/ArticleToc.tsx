...
/**
 * Sticky "on this page" rail for an ePortfolio article. Mirrors the SCA
 * guides' GuideTimeline, with the sidebar CTA pointing at the portfolio tool
 * rather than the SCA case library. Collapses to a native <details> on mobile.
 */
            ...
            <aside className="hidden lg:block sticky top-28 self-start" aria-label="On this page">
                ...
                <div className="mt-7 rounded-[14px] border border-[#e6dccb] bg-[#fbf8f2] p-5">
                    ...
                    <p className="mt-3 text-sm leading-relaxed text-body">
                        Turn a short description of an encounter into a structured clinical case
                        review, mapped to the RCGP capability framework.
                    </p>
                    <Link
                        href={PORTFOLIO_TOOL_PATH}
