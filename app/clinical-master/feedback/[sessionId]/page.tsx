...
export default function FeedbackPage() {
    ...
    const fetchFeedback = async () => {
      try {
        const response = await fetch(
          `${CLINICAL_MASTER_BACKEND_URL.replace('ws://', 'http://').replace('wss://', 'https://')}/feedback/${sessionId}`
        );
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#0F1324] flex items-center justify-center">
  ...
  return (
    <div className="min-h-screen bg-[#0F1324] flex selection:bg-indigo-500/30">
      {/* Sidebar */}
      <aside className="w-[240px] border-r border-white/5 flex flex-col shrink-0 h-screen sticky top-0 bg-[#0F1324]/80 backdrop-blur-xl">
        <div className="p-6">
          <div className="flex items-center gap-3 mb-10">
            <div className="size-8 bg-gradient-to-br from-blue-600 to-indigo-600 rounded-lg flex items-center justify-center shadow-lg shadow-indigo-500/20 ring-1 ring-white/10">
              <span className="material-symbols-outlined text-white text-xl">sailing</span>
            </div>
            <h1 className="text-white text-base font-bold tracking-tight">Fisherman</h1>
          </div>
          
          <nav className="space-y-1">
            <Link href="/clinical-master" className="flex items-center gap-3 px-4 py-3 rounded-xl text-gray-400 hover:text-white hover:bg-white/5 transition-all">
            ...
            <a href="#" className="flex items-center gap-3 px-4 py-3 rounded-xl text-gray-400 hover:text-white hover:bg-white/5 transition-all">
              ...
              <span className="text-sm font-medium">Station Library</span>
            </a>
            <a href="#" className="flex items-center gap-3 px-4 py-3 rounded-xl bg-white/5 border border-white/5 text-white">
        ...
        <header className="px-8 py-5 border-b border-white/5 relative overflow-hidden">
          ...
          <div className="max-w-6xl mx-auto flex items-center justify-between relative z-10">
            <div className="space-y-2 max-w-lg">
              ...
              <h2 className="text-3xl font-bold text-white tracking-tight">Chest Pain Station</h2>
            </div>
            ...
            <div className="flex items-center gap-6">
              ...
              <div className={`px-6 py-3 rounded-xl font-bold text-lg tracking-widest text-center min-w-[140px] h-[86px] flex items-center justify-center ${
                isPassing 
