  ...
  return (
    <AuthLayout>
      <AuthCard
        ...
        subtitle={
          plan
            ? `You selected the ${plan} plan. Create your account to get started.`
            : 'Join Fourteen Fisherman and start your SCA preparation journey.'
        }
      >
        <form onSubmit={handleSignUp} className="space-y-5">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full py-3 bg-gradient-to-br from-primary to-primary-light disabled:opacity-50 disabled:cursor-not-allowed text-white font-semibold rounded-lg transition-all flex items-center justify-center gap-2 cursor-pointer"
          >
