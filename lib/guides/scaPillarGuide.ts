...
export const pillarSections: PillarSection[] = [
    {
        ...
        paragraphs: [
            ...
            'The exam runs across around 9 diets each year, and the fee is over £1,200 per attempt, which is one more reason to prepare in a way that gives you the best chance of passing first time. The full mechanics, including eligibility, booking, fees and dates, are covered in What Is the SCA: Format, Cost and Eligibility.',
        ],
        links: [
            {
