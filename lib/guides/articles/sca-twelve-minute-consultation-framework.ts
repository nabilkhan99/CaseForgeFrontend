...
export const scaTwelveMinuteConsultationFramework: GuideArticle = {
    ...
    sections: [
        ...
        {
            id: 'training-the-framework-until-it-is-automatic',
            title: 'Training the framework until it is automatic',
            blocks: [
                {
                    type: 'text',
                    text: 'A structure you have read is not a structure you have. The framework above becomes real through timed repetition: full 12 minute cases, a visible clock, the 6 to 7 minute checkpoint enforced, and a debrief afterwards against the 3 domains, with the RAG tool layered in periodically for precision. 2 to 3 cases per session, a few sessions a week in the core preparation phase, is enough for the rhythm to become automatic, and the week by week escalation is laid out in [link: How to Build Your SCA Revision Timeline].',
                },
                {
                    type: 'text',
