                ...
                },
                {
                    ...
                    rows: [
                        [
                            ...
                            '**£299 for 3 month access; £599 bundle with AI practice, a 3 hour one to one coaching session and on-demand lectures (eligible for the NHSE study budget)**',
                            '**The only SCA programme that combines AI practice, one to one coaching and on-demand lectures, and the only one with a pass guarantee.**',
                        ],
                        [
