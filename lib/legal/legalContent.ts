/**
 * Approved legal copy (Terms, Privacy, Cookies) for the /terms page.
...
|---|---|
| Providing your course, scoring stations, tracking progress, administering the guarantee | Performance of a contract |
| Providing the free portfolio tool | Performance of a contract (terms of use) |
| Taking payment and keeping accounting records | Legal obligation and contract |
...
|---|---|---|---|
| Session cookie | Keeps you logged in | Strictly necessary | Session |
| Consent cookie | Stores your cookie choice | Strictly necessary | 12 months |
| __stripe_mid | Payment fraud prevention (Stripe) | Strictly necessary | 12 months |
| __stripe_sid | Payment fraud prevention (Stripe) | Strictly necessary | 30 minutes |
| Analytics cookies | Site and platform analytics | Consent-based | 12 months |
`;
