    ...
    <div className="space-y-4">
      <div className="relative">
        <button
          ...
          className="w-full flex justify-between items-center px-4 py-2.5 min-h-[44px] bg-white border border-gray-300 rounded-lg shadow-sm hover:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all duration-200"
        >
          ...
          <div className="absolute z-10 w-full mt-1 bg-white rounded-lg shadow-lg border border-gray-200 animate-slideDown">
            <div className="max-h-60 overflow-auto py-1">
              <button
                ...
                className={`w-full text-left px-4 py-2 min-h-[44px] hover:bg-indigo-50 transition-colors duration-150 border-b border-gray-200
              ...
              {Object.keys(capabilities).map((cap) => (
                <button
                  ...
                  className={`w-full text-left px-4 py-2 min-h-[44px] hover:bg-indigo-50 transition-colors duration-150
