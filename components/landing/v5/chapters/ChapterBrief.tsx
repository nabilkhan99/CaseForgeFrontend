    ...
    <div className="flex h-full flex-col p-5 lg:p-6">
      ...
      <div className="mb-5">
        <div className="grid grid-cols-1 gap-2">
          <div className="flex items-start gap-2 px-3 py-2.5 rounded-lg bg-black/[0.02]">
            <span className="text-[10px] font-bold text-stone-400 uppercase tracking-wide w-[110px] flex-shrink-0 pt-0.5">
              Patient Name
            </span>
            <span className="text-[14px] font-semibold text-heading">Jack Thompson</span>
          </div>
          <div className="flex items-start gap-2 px-3 py-2.5 rounded-lg bg-black/[0.02]">
            <span className="text-[10px] font-bold text-stone-400 uppercase tracking-wide w-[110px] flex-shrink-0 pt-0.5">
              Age
            </span>
            <span className="text-[13px] text-stone-600">12 (DOB: 14/05/2013)</span>
          </div>
        </div>
      </div>
      ...
      <div className="mb-5">
        ...
        <div
          className="px-4 py-3.5 rounded-xl text-[14px] text-heading leading-[1.7] font-medium italic"
          style={{
      ...
      <div className="mb-5">
        ...
        <div className="flex flex-col gap-1.5">
          <div className="flex items-start gap-2">
            ...
            <span className="text-[13px] text-stone-600 leading-[1.6]">
      ...
      <motion.div
        className="mt-auto w-full py-3.5 rounded-xl text-center text-[14px] font-semibold text-white cursor-pointer"
        style={{
