 ...
 * against white. Untouched sits at 0.2 here rather than the square's 0.08:
 * a swatch has no neighbours to be faint against.
 */
const CHIP_DOT: Record<SquareStatus, string> = {
    passed: '#16A34A',
    attempted: '#D97706',
    ...
    return (
        ...
        >
            <div className="flex items-center justify-between gap-4">
                {/* Filter and legend in one control: three chips that each say
                    what their colour means and switch the board to it. A
                    separate read-only key beside them would be the same three
                    words twice. */}
                <div className="flex items-center gap-1.5" role="group" aria-label="Filter by progress">
